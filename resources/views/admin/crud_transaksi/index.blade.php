                        ...
                        <tr class="hover:bg-gray-50 transition-all duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex space-x-2">
                                    <button onclick="showDetail({{ $transaksi->id }})" class="inline-flex items-center px-3 py-1.5 bg-emerald-100 text-emerald-700 hover:bg-emerald-200 rounded-lg text-sm font-medium transition-colors duration-200">
