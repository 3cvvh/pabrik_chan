...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-4xl font-extrabold text-gray-800 tracking-tight">transaksi List</h1>
        ...
        <div class="mb-6 p-4 bg-white rounded-lg shadow-sm flex gap-4">
            ...
            <input autocomplete="off" name="search" type="text" placeholder="Search transaksis..." class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all duration-200">
              <select name="roles_key" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400">
                <option value="0">All Pembeli</option>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{{ $transaksi->pabrik->name }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $transaksi->total_harga }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $transaksi->status }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex space-x-2">
                                <a href="{{ route('crud_users.edit',$transaksi->id) }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-100 text-indigo-700 hover:bg-indigo-200 rounded-lg text-sm font-medium transition-colors duration-200">Edit</a>
