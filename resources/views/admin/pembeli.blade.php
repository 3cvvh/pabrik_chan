...
<div class="container mx-auto mt-8 px-4">
    <h2 class="text-2xl font-bold mb-4">Data Pembeli</h2>
   @foreach (['tambah' => 'blue', 'edit' => 'yellow', 'hapus' => 'red', 'success' => 'green', 'error' => 'red'] as $message => $color)
    ...
    @endif
@endforeach
    <a href="/dashboard/admin/pembeli/create" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded mb-4 transition">Tambah Pembeli</a>
        ...
        <table class="min-w-full bg-white border border-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="py-3 px-4 border-b text-left">No Telepon</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-2 px-4 border-b">{{ $pembeli->name }}</td>
                    <td class="py-2 px-4 border-b">{{ $pembeli->alamat }}</td>
                    <td class="py-2 px-4 border-b">{{ $pembeli->no_telepon }}</td>
                    <td class="py-2 px-4 border-b">
                        <a href="/dashboard/admin/pembeli/{{ $pembeli->id }}/edit" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-white font-semibold py-1 px-3 rounded mr-2 transition">Edit</a>
                        <form action="/dashboard/admin/pembeli/{{ $pembeli->id }}" method="POST" class="inline" style="display:inline;">
                            @csrf
                            @method('DELETE')
