<nav class="bg-blue-500 border-t-2 border-black px-8 py-3 flex items-center justify-between">
    ...
    <div class="flex items-center space-x-4">
        <a href="#" class="bg-white text-blue-600 font-semibold px-4 py-1 rounded shadow hover:bg-blue-100 transition">Dashboard</a>
        ...
        <a href="/pabrik" class="flex items-center text-white font-medium hover:text-blue-200 transition">
