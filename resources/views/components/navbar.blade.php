<nav class="bg-blue-500 border-t-2 border-black px-8 py-3 flex items-center justify-between">
    ...
    <div class="flex items-center gap-6">
        ...
        <a href="/dashboard/admin/crud_gudang" class="flex items-center text-white font-medium hover:text-blue-200 transition">
        ...
        <a href="{{ route('owner.index') }}" class="flex items-center text-white font-medium hover:text-blue-200 transition">
            <i class="fas fa-chart-bar w-5 h-5 mr-1"></i>
            data laporan
        </a>
        <a href='{{ route('owner.dash') }}' class="flex items-center text-white font-medium hover:text-blue-200 transition">
