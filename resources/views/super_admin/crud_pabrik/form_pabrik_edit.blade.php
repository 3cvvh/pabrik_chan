...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-8 px-2 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto animate-fadeIn">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 animate-slideUp">
            <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-6">Edit Data Pabrik</h2>
            <form action="/dashboard/super_admin/crud_pabrik/{{ $pabrik->id }}" method="post" class="space-y-6" enctype="multipart/form-data" id="edit-form">
                @csrf
                @method('put')
...
function confirmUpdate() {
    Swal.fire({
        ...
        text: "Data pabrik akan diperbarui",
        icon: 'warning',
