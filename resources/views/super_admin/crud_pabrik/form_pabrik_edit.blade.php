...
                <div class="mb-6">
            <a href="/dashboard/super_admin/crud_pabrik" class="inline-flex items-center text-gray-600 hover:text-gray-800">
...
            <form action="/dashboard/super_admin/crud_pabrik/{{ $pabrik->id }}" method="post" class="space-y-6" enctype="multipart/form-data">
                @csrf
                @method('put')
